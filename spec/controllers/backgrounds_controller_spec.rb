...
describe BackgroundsController do
  ...
  describe "GET index" do
    it "assigns all backgrounds as @backgrounds" do
      ...
      assigns(:backgrounds).should eq([background])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested background as @background" do
      ...
      assigns(:background).should eq(background)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new background as @background" do
      ...
      assigns(:background).should be_a_new(Background)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created background as @background" do
        post :create, {:background => valid_attributes}, valid_session
        assigns(:background).should be_a(Background)
        assigns(:background).should be_persisted
      end

      it "redirects to the created background" do
        post :create, {:background => valid_attributes}, valid_session
        response.should redirect_to(Background.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved background as @background" do
        ...
        Background.any_instance.stub(:save).and_return(false)
        post :create, {:background => {  }}, valid_session
        assigns(:background).should be_a_new(Background)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested background" do
        background = Background.create! valid_attributes
        # Assuming there are no other backgrounds in the database, this
        # specifies that the Background created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Background.any_instance.should_receive(:update_attributes).with({ "these" => "params" })
        put :update, {:id => background.to_param, :background => { "these" => "params" }}, valid_session
      end
      ...
      it "redirects to the background" do
        background = Background.create! valid_attributes
        put :update, {:id => background.to_param, :background => valid_attributes}, valid_session
        response.should redirect_to(background)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the background as @background" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Background.any_instance.stub(:save).and_return(false)
        put :update, {:id => background.to_param, :background => {  }}, valid_session
        assigns(:background).should eq(background)
      end
