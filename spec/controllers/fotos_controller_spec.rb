  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved foto as @foto" do
        ...
        post :create, {:foto => { "titulo" => "invalid value" }}, valid_session
        assigns(:foto).should be_a_new(Foto)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested foto" do
        ...
        Foto.any_instance.should_receive(:update_attributes).with({ "titulo" => "MyString" })
        put :update, {:id => foto.to_param, :foto => { "titulo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the foto as @foto" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Foto.any_instance.stub(:save).and_return(false)
        put :update, {:id => foto.to_param, :foto => { "titulo" => "invalid value" }}, valid_session
        assigns(:foto).should eq(foto)
      end
